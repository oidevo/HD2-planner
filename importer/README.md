...
Run `python3.12 hd2.py catalog fetch --output catalog-staging --catalog-version YYYY.MM.DD.N`, then `python3.12 hd2.py catalog compare catalog catalog-staging --output catalog-review`. Inspect the review before replacing the accepted snapshot.
